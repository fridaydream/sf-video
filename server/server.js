...
if (!isDev) {
    ...
    var serverEntry_1 = require('../dist/server-entry.js');
    var template_1 = fs_1["default"].readFileSync(path_1["default"].join(__dirname, '../dist/server.ejs')).toString('utf8');
    app.use(function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ctx.template = template_1;
                    ctx.serverBundle = serverEntry_1;
                    return [4 /*yield*/, next()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
router.get('/video/info', handle_video_1["default"]);
app
    .use(router.routes())
